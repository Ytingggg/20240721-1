...
export default function Home() {
  return (
    <>
      <Link href={'/test'} class="btn btn-primary btn-lg px-4">
        連結至TEST頁
      </Link>
      ...
      <div className="col-lg-8 mx-auto p-4 py-md-5">
        <header className="d-flex align-items-center pb-3 mb-5 border-bottom"></header>
        <main>
          ...
          <div className="row g-5">
            ...
            <div className="col-md-6">
              ...
              <ul className="list-unstyled ps-0">
                ...
                <li>
                  <a className="icon-link mb-1" href="../getting-started/vite/">
                    <svg className="bi" width={16} height={16}>
                      <use xlinkHref="#arrow-right-circle" />
                    </svg>
