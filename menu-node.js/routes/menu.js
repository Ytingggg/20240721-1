...
menuRouter.get("/product",async(req,res)=>{
  const sql = "SELECT `id`, `name`, `price`, `image`,`popularity` FROM `one` WHERE 1";
...
menuRouter.get("/combo_meal",async(req,res)=>{
  const sql = "SELECT `id`, `name`, `price`, `image` ,`popularity` FROM `combo_meal` WHERE 1";
  const [rows] = await db.query(sql);
...
menuRouter.get("/liquor",async(req,res)=>{
  const sql = "SELECT `id`, `name`, `price`, `image`,`popularity` FROM `liquor` WHERE 1";
  const [rows] = await db.query(sql);
...
menuRouter.get("/drink",async(req,res)=>{
  const sql = "SELECT `id`, `name`, `price`, `image`,`popularity` FROM `drink` WHERE 1";
  const [rows] = await db.query(sql);
...
menuRouter.get("/dessert",async(req,res)=>{
  const sql = "SELECT `id`, `name`, `price`, `image`,`popularity` FROM `dessert` WHERE 1";
  const [rows] = await db.query(sql);
...
menuRouter.get("/bento",async(req,res)=>{
  const sql = "SELECT `id`, `name`, `price`, `image`,`popularity` FROM `bento` WHERE 1";
  const [rows] = await db.query(sql);
